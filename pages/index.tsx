...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Scott Harlan's Dev Portfolio</title>
        <meta name="description" content="My Developer Portfolio" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />

        <meta name="og:title" content="Scott Harlan's Dev Portfolio" />
        <meta name="og:description" content="My Developer Portfolio" />
        <meta property="og:image" content="/images/big-banner-bg.png" />
        <meta property='twitter:image' content="/images/big-banner-bg.png" />
        <meta name="og:url" content="https://scottharlan.dev" />
